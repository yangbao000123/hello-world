...
- number of states, reaching absorbing state is the end of game
    -  geometric series for number of head until a tail
        - path distinguished by number of head, respective probability expected payout
        - $max(V_{current}, V_{fresh}), $E[max(a,10)] = E[a] + E[(10-a)^+]$
